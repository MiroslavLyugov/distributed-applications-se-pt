        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverrideMessageId = table.Column<int>(type: "int", nullable: true),
                    DeleteEvent = table.Column<bool>(type: "bit", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_Messages_OverrideMessageId",
                        column: x => x.OverrideMessageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_OverrideMessageId",
                table: "Messages",
                column: "OverrideMessageId");
